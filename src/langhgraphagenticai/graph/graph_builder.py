...
class  GraphBuilder:
    ...
    def basic_chatbot_build_graph(self):
        ...
        This method initializes a chatbot node using the `BasicChatNode` class
        and integrates it into the graph. The chatbot node is set as both the
        entry and exit point of th graph.
        """
    ...
    def chatbot_with_tools_build_graph(self):
        ...
        capabilities, and sets up conditional and direct edges bbetween nodes.
